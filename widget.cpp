...
bool beep_flag = true;//蜂鸣器标志
static bool telflag = true; //打电话标志
...
void Widget::on_pushButton_timesetup_2_clicked()  //打电话按钮  原来查询按钮
{
//    this->close();
//    findlook.show();
//    findlook.exec();
//    this->show();
    ...
    //myCom->write("ATD18638758663;\r");//ATD18638758663;

    //myCom->write("ATD15346571206;\r");//ATD18638758663;  ATD037155373770

//     myCom->write("ATD037155373770;\r");
//    qDebug()<<"telephone ......."<<endl;
    ...
    if(telflag)
    {
        ...
        ui->pushButton_timesetup_2->setStyleSheet("QPushButton{border-image:url(./imagejy/zw/guduan.png);background-repeat: background-xy;background-position: center;background-attachment: fixed;background-clip: padding}");
        qDebug()<<"tel_flag = "<<telflag<<endl;
    ...
    {
        telflag = true;
        ui->pushButton_timesetup_2->setStyleSheet("QPushButton{border-image:url(./imagejy/zw/dianhua.png);background-repeat: repeat-xy;background-position: center;background-attachment: fixed;background-clip: padding}");

        qDebug()<<"tel_flag = "<<telflag<<endl;


        myCom->write("ATH\r");
        qDebug()<<"guduandianhu"<<endl;
    }
#endif
...
void Widget::on_pushButton_clicked() //多媒体播放
{
